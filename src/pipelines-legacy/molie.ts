// DEPRECATED: legacy MOLIE pipeline implementation.
// Use the canonical module implementation at /modules/pipelines/molie.ts instead.
...
import { MinimalBertTokenizer } from '../tokenizers/bert-tokenizer.js';
